...
module.exports = {
  IndexUrl: ApiRootUrl + 'wechat/mini/home', //首页数据接口
  // IndexUrl: ApiRootUrl + 'index/index', //首页数据接口
  CatalogList: ApiRootUrl + 'wechat/mini/goods-categories',  //分类目录全部分类数据接口
  CatalogCurrent: ApiRootUrl + 'catalog/current',  //分类目录当前分类数据接口

  AuthLoginByWeixin: ApiRootUrl + 'wechat/mini/login', //微信登录
